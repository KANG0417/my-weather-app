    ...
    <article className="flex flex-col items-center w-full pt-8 pb-8 pl-6 pr-6">
      ...
      <section className="flex flex-col items-center mb-15" aria-label="현재 기상 정보">
        <figure className="flex flex-col items-center">
          ...
          <div className="text-[8rem] font-black leading-none text-slate-900 flex items-start">
            {weather.temp}<span className="text-4xl mt-6 ml-1 text-blue-500" aria-label="도">°</span>
          </div>
